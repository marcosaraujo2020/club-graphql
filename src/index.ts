...
const resolvers = {
  ...
  Mutation: {
    createClub: async (_: any, { name, country, uf, year_foundation }: any) => {
      try {
    ...
    createPlayer: async (_: any, { name, age, shirt_number, position, clubId }: any) => {
      try {
